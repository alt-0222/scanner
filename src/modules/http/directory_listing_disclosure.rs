...
mod tests {
	...
	async fn is_directory_listing() {
		...
		let body = String::from("Content <title>Index of <url></title> test");
		let body2 = String::from(">Access> Content <title>Index of <url></title>");
		let body3 = "".to_owned();
		let body4 = String::from("test123< test> test  <title>Index</title> test");
